...
| 009 | 2026-06-23 | UX/completeness review before declaring the template inheritable | in-progress | Reviewing the template's adopter UX and completeness (README, onboarding, layout, errors, docs) ahead of declaring it ready to be inherited from. |
